...
//       return;
//     }
//     var new_image = $(`<input multiple= "multiple" name="photos[url][]" class="upload-image" data-image= ${images.length} type="file" id="upload-image">`);
...
//       if ($(this).data('photo') == target_photo.data('photo')){
//         $(this).remove();
//         target_photo.remove();
